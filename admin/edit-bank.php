...
if (strlen($_SESSION['adminlogin']) == 0) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $query = mysqli_query($con, "UPDATE tbl_payment SET bank_name = '$bank_name', bank_detail = '$bank_detail', user_name = '$username' WHERE payment_id = '$id'");
            ...
            <div class="content col-md-10">
                <section class="category-container mb106">
                    <div class="category_head mb20">
                        <p class="text fs16 fw-bolder px10-py20 w100pt bg-default m-0">Edit Bank</p>
                    </div>
                    <div class="category_body">
                        <form action="" method="post">
                            <?php
                            $id = intval($_GET['id']);
                            $query = mysqli_query($con, "SELECT * FROM tbl_payment WHERE payment_id = '$id'");
                            while ($row = mysqli_fetch_array($query)) {
                                ...
                                <div class="control-group mb20 row">
                                    ...
                                    <input type="text" name="bank_detail" class="col-sm-9 w400 col-md-9 "
                                        value="<?php echo $row['bank_detail'] ?>">
                                </div>
                                <div class="control-group mb20 row">
