...
if (strlen($_SESSION['adminlogin']) == 0) {
    ...
    if (isset($_GET['del'])) {
        $id = intval($_GET['id']);
        mysqli_query($con, "DELETE FROM tbl_post WHERE post_id = '$id'");
    }
}
?>
<!DOCTYPE html>
        ...
        <div class="row">
            ...
            <section class="users_container col-md-10">
                <div class="users_head mb20">
                    <p class="text-capitalize fs16 fw-bolder px10-py20 w100pt bg-default m-0">View Blog</p>
                </div>
                <div class="users_body">
                    <div class=" order-container">
                        <div class="col-md-12 mt20">
                            <div class="manage-blogs-table">
                                <table class="w100pt">
                                    <thead class="manage-blogs_head">
                                        <tr
                                            ...
                                            <td class="col-md-2 border-end border-dark">Tiêu đề bài viết</td>
                                            <td class="col-md-2 border-end border-dark">Danh mục bài viết</td>
                                            <td class="col-md-2 border-end border-dark">Ảnh thumbnail</td>
                                            <td class="col-md-3 border-end border-dark">Post Creation Date</td>
                                            <td class="col-md-2">Action</td>
                                        </tr>
                                    </thead>
                                    <tbody class="manage-products_body">
                                        <?php
                                        $query = mysqli_query($con, "SELECT tbl_post.*, tbl_category_post.* FROM tbl_post JOIN tbl_category_post ON tbl_category_post.category_post_id = tbl_post.category_post_id");
                                        $count = 1;
                                        while ($row = mysqli_fetch_array($query)) {
                                            ...
                                            <tr class="odd text-start fs14 w100pt border border-dark">
                                                ...
                                                <td class="col-md-2 p10 border-end border-dark">
                                                    <img src="<?php echo htmlentities($row['post_thumb']); ?>" alt="">
                                                </td>
                                                <td class="col-md-3 p10 border-end border-dark">
                                                    <p class="name w100pt m-0">
                                                        <?php echo htmlentities($row['reg_date']); ?>
                                                    </p>
                                                </td>
                                                <td class="col-md-2 p10">
                                                    <p class="w100pt m-0">
                                                        ...
                                                        <a href="manage-blog.php?id=<?php echo $row['post_id'] ?>&del=delete"
